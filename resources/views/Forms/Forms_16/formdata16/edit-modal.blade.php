<div class="modal fade editForm16" wire:ignore.self tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog  modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit / Update INCIDENT REPORT FORM</h5>
                ...
                <form wire:submit.prevent="update">
                    <fieldset class="row g-3" {{ $role == 'Project Head' ? 'disabled' : '' }}>
                                    ...
                                    @foreach ($potentialinjurytotData as $item)
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label"
                                                for="{{ $item->potential_injurytos_abbr }}">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                <label for="" class="@error('injuredvictim_name') text-danger @enderror">Injured Victim
                                    Name
                        ...
                        <div class="col-md-2 col-sm-6">
                            <div class="form-group">
                                <label for="" class="@error('eml_id_no') text-danger @enderror">ID No
                                    @error('eml_id_no') <i class="text-danger fas fa-times-circle"></i>@enderror</label>
                        ...
                        <div class="col-md-2 col-sm-6">
                            <div class="form-group">
                                <label for="project name"
                                    class="form-label @error('gender_fk') text-danger @enderror">Sex
                        ...
                        <div class="col-md-2 col-sm-6">
                            <div class="form-group">
                                <label for="" class=" @error('doj_dt') text-danger @enderror">Date of joing
                                    @error('doj_dt')
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <div class=" form-group">
                                <div class="form-group form-check-inline">
                                    <input wire:model='married' class="form-check-input" name="maritalStatus"
                                        type="radio" value="1" id="married">
                                ...
                                <div class="form-group form-check-inline">
                                    <input wire:model='married' class="form-check-input" name="maritalStatus"
                                        type="radio" value="0" id="unmarried">
                        ...
                        <div class="col-md-2 col-sm-6">
                            <label class=" @error('person_on_duty') text-danger @enderror">Was the person on duty
                                @error('person_on_duty') <i
                                    class="text-danger fas fa-times-circle"></i>@enderror</label>
                            <div class=" form-group">
                                <div class="form-group form-check-inline">
                                    <input wire:model='person_on_duty' class="form-check-input" name="onDuty"
                                        type="radio" value="1" id="onDutyYES">
                                ...
                                <div class="form-group form-check-inline">
                                    <input wire:model='person_on_duty' class="form-check-input" name="onDuty"
                                        type="radio" value="0" id="onDutyNO">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <label title="Was the person authorized to be in the Incident area"
                                class=" @error('person_authorized_2_incident_area') text-danger @enderror">Person
                                authorized
                                to be in
                        ...
                        <div class="col-md-3 col-sm-6">
                            <label class=" @error('first_aid_given_on_site') text-danger @enderror">Was First Aid given
                                on
                                Site @error('first_aid_given_on_site') <i
                                    class="text-danger fas fa-times-circle"></i>@enderror</label>
                            <div class=" form-group">
                                <div class="form-group form-check-inline">
                                    <input wire:model='first_aid_given_on_site' class="form-check-input"
                                        name="firstaid" type="radio" value="1" id="wasfirstaidyes">
                                ...
                                <div class="form-group form-check-inline">
                                    <input wire:model='first_aid_given_on_site' class="form-check-input"
                                        name="firstaid" type="radio" value="0" id="wasfirstaidno">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label for="nameofaider"
                                    class="form-label @error('name_first_aider') text-danger @enderror">Name of the
                                    First
                                    Aider @error('name_first_aider') <i
                                        class="text-danger fas fa-times-circle"></i>@enderror</label>
                                <input wire:model='name_first_aider' type="text" class="form-control"
                                    id="nameofaider">
                                {{-- <span class="text-danger">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <label class="@error('victim_taken_hospital') text-danger @enderror">Was the victim taken
                                to a
                        ...
                        <div class="col-md-3 col-sm-6">
                                ...
                                <div class="form-group">
                                    <label title="State whether he returned to work. If so, when" for="returntoworkifdt"
                                        ...
                                        victim... @error('return_to_work') <i
                                            class="text-danger fas fa-times-circle"></i>@enderror</label>
                                    <input {{ $victimDischargeorNot == 'No' ? 'disabled' : '' }}
                                        wire:model='return_to_work' type="date" class="form-control"
                                        id="returntoworkifdt">
                                    {{-- <span class="text-danger">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label
                                        title="Description of incident, injury in brief (Attach sketches/photos as required)"
                                        for="" class=" @error('description_of_incident') text-danger @enderror">Description
                                        of
