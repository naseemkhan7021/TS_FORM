<div class="modal fade editEnvironmentalImpact" wire:ignore.self tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit / Update Environmental Impact</h5>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="detail_add"
                                        class="@error('environmental_impact_detail') text-danger @enderror">Detail</label>
                                    <textarea wire:model='environmental_impact_detail' placeholder="Detail about {{$environmental_impact_description}}"
                                        name="detail" id="detail_add" rows="4"
                                        class="form-control @error('environmental_impact_detail') border border-danger @enderror"></textarea>
                                </div>
