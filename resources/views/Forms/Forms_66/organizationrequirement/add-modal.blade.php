<div class="modal fade addOrganizationrequirment" wire:ignore.self tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add New Organization Requirement</h5>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="detail_add" class="@error('organization_requirement_detail') text-danger @enderror">Detail</label>
                                    <textarea wire:model='organization_requirement_detail' placeholder="Detail about {{$organization_requirement_description}}" name="detail" id="detail_add" rows="4" class="form-control @error('organization_requirement_detail') border border-danger @enderror"></textarea>
                                </div>
