@extends('template.vertical', ['title' => 'Forms66 - Activity'])
...
<div class="container-fluid pl-3 pr-3">
    ...
    <!-- start page title -->
        @livewire('page-title', [ 'sub_title' => 'FORMS66' , 'active_title' => 'Form 66 Activity' , 'page_title' => 'Form 01 Activity'  ])
        @livewire('forms66.activity66')
    <!-- end page title -->
