<div class="modal fade addScaleofimpact" wire:ignore.self tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add New Scale Of Impact</h5>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="detail_add" class="@error('scale_of_impact_detail') text-danger @enderror">Detail</label>
                                    <textarea wire:model='scale_of_impact_detail' placeholder="Detail about  {{$scale_of_impact_description}}" name="detail" id="detail_add" rows="4" class="form-control @error('scale_of_impact_detail') border border-danger @enderror"></textarea>
                                </div>
