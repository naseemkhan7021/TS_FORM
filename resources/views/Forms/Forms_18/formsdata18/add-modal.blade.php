<div class="modal fade addFormdata18" wire:ignore.self tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form wire:submit.prevent="save" class="row g-3">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="type_add" class="@error('type') text-danger @enderror">Type</label>
                            <input id="type_add" type="text"
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="size_add" class="@error('size') text-danger @enderror">Size</label>
                            <input id="size_add" type="text"
                            ...
                            <div class="form-control @error('pressure_gauge_or_safety_pin_status') border border-danger @enderror">
                                <div class="form-check form-check-inline">
                                    <input checked wire:model='pressure_gauge_or_safety_pin_status' value="Good"
                                        class="form-check-input" name="status_add" type="radio" id="Good_add">
                                    <label class="form-check-label" for="Good_add">Good</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input wire:model='pressure_gauge_or_safety_pin_status' value="Bad"
                                        class="form-check-input" name="status_add" type="radio" id="Bad_add">
                                    <label class="form-check-label" for="Bad_add">Bad</label>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-control @error('seal_intact_and_not_corroded') border border-danger @enderror">
                                <div class="form-check form-check-inline">
                                    <input checked wire:model='seal_intact_and_not_corroded' value="Yes"
                                        class="form-check-input" name="sealIntact_add" type="radio" id="Yes_add">
                                    <label class="form-check-label" for="Yes_add">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input wire:model='seal_intact_and_not_corroded' value="No" class="form-check-input"
                                        name="sealIntact_add" type="radio" id="No_add">
                                    <label class="form-check-label" for="No_add">No</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="Date_Of_Refilling_add" class="@error('date_of_refilling') text-danger @enderror">Date Of Refilling</label>
                            <input id="Date_Of_Refilling_add" type="date" max="<?= date('Y-m-d') ?>"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="Date_Of_Inspection_add" class="@error('date_of_inspection') text-danger @enderror">Date Of Inspection</label>
                            <input id="Date_Of_Inspection_add" type="date" max="<?= date('Y-m-d') ?>"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="due_for_next_Refilling_add" class="@error('due_for_next_refilling') text-danger @enderror">Due next Refilling</label>
                            <input readonly id="due_for_next_Refilling_add" type="date"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="due_for_next_Inspection_add" class="@error('due_for_next_inspection') text-danger @enderror">Due next Inspection</label>
                            <input readonly id="due_for_next_Inspection_add" type="date"
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <div class="form-check form-check-inline form-control border @error('inspected_by_signature') border-danger @enderror">
                            <input wire:model='inspected_by_signature' class="form-check-input ml-2" type="checkbox" id="completedbysignature_add" value="1">
