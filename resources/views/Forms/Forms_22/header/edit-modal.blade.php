                    ...
                    <fieldset class="row g-3" {{ $role == 'Project Head' ? 'disabled' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control  @error('contractor_name') border-danger @enderror"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="venue" type="text"
                                    class="form-control  @error('venue') border-danger @enderror" placeholder="venue"
                                    wire:model="venue">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="duration" type="text"
                                    class="form-control  @error('duration') border-danger @enderror"
                                    placeholder="Duration" wire:model="duration">
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <label for=""><strong><u class="">Undertaking</u></strong>
                                <p class="mb-1">
                                    ...
                                    requirements of following Health & Safety rules in work place and agreed to follow
                                    them.
                                    My signature is appended below.
                                    The following Staff / Technicians / Contractor / Labour have joined and commenced
                                    work
                            ...
                            @else
                                <table class="table text-center">
                                    <h4 class="text-center">ALL Added Member <a
                                            wire:click='openParticipantsModel({{ $partisipanceId }})' href="#">
                                            Edit</a>
                                    </h4>
                                    <thead>
                                        <tr>
