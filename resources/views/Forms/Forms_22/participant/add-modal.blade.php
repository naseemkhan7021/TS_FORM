<div class="modal fade addParticipants" wire:ignore.self tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    {{-- <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="signature" type="text"
                                class="form-control  @error('signature') border-danger @enderror"
                                placeholder="signature" wire:model="signature">
                        </div>
                    </div> --}}
