<div class="modal fade addNearmissreporting" wire:ignore.self tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add New Nearmiss Reporting</h5>
            ...
            <div class="modal-body">
                <form wire:submit.prevent="save" class="row g-3">
                    ...
                    <div class="col-12 form-group">
                        ...
                        <textarea minlength="100" maxlength="1000" wire:model='details_of_nearmiss' id="details" class="form-control @error('details_of_nearmiss') border-danger @enderror"
                            rows="5"></textarea>
                    </div>
                                    ...
                                    <div class="text-justify border @error('imd_actions_ids') border-danger @enderror">
                                        ...
                                        <div class="form-check my-1 ml-2">
                                            <input wire:model='imd_actions_ids' class="form-check-input" type="checkbox"
                                                ...
                                                id="imdactions_{{ $item->imd_actions_id }}_add">
                                            <label class="ml-3 form-check-label"
                                                for="imdactions_{{ $item->imd_actions_id }}_add">
                                                {{ $item->imd_actions_id }}.
                                    ...
                                    <div class="text-justify border @error('imd_corrections_ids') border-danger @enderror"">
                                        ...
                                        <div class="form-check my-1 ml-2">
                                            <input wire:model='imd_corrections_ids' class="form-check-input"
                                                ...
                                                id="imdcorrections_{{ $item->imd_corrections_id }}_add">
                                            <label class="ml-3 form-check-label"
                                                for="imdcorrections_{{ $item->imd_corrections_id }}_add">
                    ...
                    <div class="col-12 form-group">
                        ...
                        <textarea minlength="100" maxlength="600" wire:model='further_recommended_action' id="furtheraction" class="form-control border @error('further_recommended_action') border-danger @enderror"
                            rows="5"></textarea>
                    </div>
