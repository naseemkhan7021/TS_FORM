    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit / Update Nearmiss Reporting
                </h5>
                    ...
                    <fieldset class="row g-3" {{ $role == 'Project Head' ? 'disabled' : '' }}>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('report_no') border-danger @enderror"
                                    placeholder="ID No" wire:model="report_no">
                            </div>
                        </div>
                        ...
                        <div class="col-12 form-group">
                            <label for=""
                                class="@error('nature_of_potential_injuries_ids') text-danger @enderror"><strong>Nature
                                    of Potential Injury:</strong> ( Tick ✓ in the Boxes )
                                @error('nature_of_potential_injuries_ids') <i
                                    class="text-danger fas fa-times-circle"></i>@enderror</label>
                            ...
                            <div class="row">
                                @foreach ($NatureofpotentialData as $index => $item)
                                    <div class="col-md-4 mt-2">
                                        <div class="form-check form-check-inline">
                                            <input wire:model='nature_of_potential_injuries_ids'
                                                class="form-check-input" type="checkbox"
                                                id="nature_{{ $item->nature_of_potential_injuries_id }}"
                        ...
                        <div class="col-12 form-group">
                            <label for=""
                                class="@error('activity15s_ids') text-danger @enderror"><strong>Activity:</strong> (
                                Tick ✓ in the Boxes ) @error('activity15s_ids') <i
                                    class="text-danger fas fa-times-circle"></i>@enderror</label>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label class="form-label" for="supervisorStatement"><strong>Cause:</strong> ( Tick ✓
                                    in
                                    the Boxes )</label>
                                        ...
                                        <div class="text-justify border @error('imdcause15s_ids') border-danger @enderror"">
                                            ...
                                            <div class="form-check my-1 ml-2">
                                                <input wire:model='imdcause15s_ids' class="form-check-input"
                                                    type="checkbox" value="{{ $item->cause15s_id }}"
                                            ...
                                            <div class="form-check form-check-inline my-1 ml-4">
                                                <input wire:model='imdcause15s_other' class="form-control " type="text"
                                                    id="otherNatrue" placeholder="Details if required:">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="col-12 form-group">
                            <label for=""
                                class="@error('whyunsafeact_committeds_ids') text-danger @enderror"><strong>Why was the
                                    unsafe act committed:</strong> ( Tick ✓ in the Boxes
                                )@error('whyunsafeact_committeds_ids') <i
                                    class="text-danger fas fa-times-circle"></i>@enderror</label>
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <div class="form-check form-check-inline">
                                            <input wire:model='whyunsafeact_committeds_ids' class="form-check-input"
                                                type="checkbox"
                                                id="whyunsafeact_{{ $item->whyunsafeact_committeds_id }}"
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label class="form-label" for="supervisorStatement"><strong>Immediate Corrective
                                        Action
                                        ...
                                        <div class="text-justify border @error('imd_actions_ids') border-danger @enderror"">
                                            ...
                                            <div class="form-check my-1 ml-2">
                                                <input wire:model='imd_actions_ids' class="form-check-input"
                                                    type="checkbox" value="{{ $item->imd_actions_id }}"
                        ...
                        <div class="col-4 form-group">
                            ...
                            <div
                                class="form-check form-check-inline form-control border @error('completed_by_signature') border-danger @enderror">
                                <input wire:model='completed_by_signature' class="form-check-input ml-2"
                                    type="checkbox" id="completedbysignature" value="1">
