            ...
            <div style="flex-direction: column;" class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                ...
                @if (Route::has('login'))
                    <div style="justify-content: space-between;" class="px-6 py-4 flex ">
                        @auth
                            <a href="{{ url('/dashboard') }}"
                                class="text-sm text-gray-700 dark:text-gray-500 btn btn-outline-success">Dashboard</a>
                        @else
                            <a href="{{ route('login') }}"
                                class="text-sm text-gray-700 dark:text-gray-500 btn btn-outline-success">Log
                                in</a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}"
                                    class="ml-4 text-sm text-gray-700 dark:text-gray-500 btn btn-outline-success">Register</a>
                            @endif
                        @endauth
                    </div>
                @endif
