<div>
    @php $button_title = 'Add New Administrative Control Mitigative' @endphp
    @php $data_not_found = 'No Administrative Control Mitigative Data Found' @endphp
        ...
        <tbody>
            @forelse ( $activitydata as  $row )
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <button class="btn btn-success btn-sm" wire:click="OpenEditCountryModal({{$row->administrative_control_mitigative_id}})">Edit</button>
                            <button class="btn btn-danger btn-sm" wire:click="deleteConfirm({{$row->administrative_control_mitigative_id}})">Delete</button>
