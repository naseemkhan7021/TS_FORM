...
@section('scripts')
    ...
    <script>
        ...
        //     $('.addDashboardPreSales').find('span').html('');
        //     $('.addDashboardPreSales').find('form')[0].reset();
        //     $('.addDashboardPreSales').modal('show');
        // });

        // window.addEventListener('CloseAddCountryModal', function(){
        //     $('.addDashboardPreSales').find('span').html('');
        //     $('.addDashboardPreSales').find('form')[0].reset();
        //     $('.addDashboardPreSales').modal('hide');
        ...
        window.addEventListener('CloseEditCountryModal', function(event){
            ...
            $('.addDashboardPreSales').find('form')[0].reset();
            $('.addDashboardPreSales').modal('hide');
            alert('Dashboard been Updated Successfully');
        });
