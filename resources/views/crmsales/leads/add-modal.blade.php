                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <input wire:model="selectedUnits" type="text" class="form-control" placeholder="Units" autocomplete="off"  readonly >
                                    ...
                                    <tr>
                                        <br>
                                          @if (count($salesunits)>0)
                                            ...
                                            <td>
                                                <input type="checkbox" class="checkbox checkbox-primary" wire:model="selectedUnits"    value = {{ $su->salesunit_id }} />
