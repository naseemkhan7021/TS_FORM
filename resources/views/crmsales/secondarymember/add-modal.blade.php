...
<div class="modal fade addSecondaryMember" wire:ignore.self tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-xl" role="document" id="addSecondaryMember">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add New Secondary Member</h5>
            ...
            <div class="modal-body">
                <form wire:submit.prevent="save" autocomplete="off">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-6">
                                <label for="pmembername">Primary Member Name With Purchased Unit</label>
                                <select wire:model='iMemberID_FK' name="primermembername" id="pmembername" class="form-control">
                                    <option value="0" hidden>SELECT PRIMERY MEMBER NAME WITH PURCHASE UNIT</option>
                            ...
                            <div class="col-2">
                                ...
                                <select wire:model='iRelationTypeID_FK' id="relationship" class="form-control">
                            ...
                            <div class="col-md-2">
                                ...
                                <input wire:model="dtDOBK" type="text" class="form-control" readonly
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" placeholder="First Name"
                                    wire:model.lazy="sSecondary_FirstName" autocomplete="false">
                                <span class="text-danger"> @error('sSecondary_FirstName')
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" placeholder="Middle Date"
                                        wire:model="sSecondary_MiddleName" autocomplete="false">
                                    <span class="text-danger"> @error('sSecondary_MiddleName')
                                            {{ $message }}@enderror</span>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" placeholder="last Name"
                                            wire:model="sSecondary_LastName" autocomplete="false">
                                        <span class="text-danger"> @error('sSecondary_LastName')
                                                {{ $message }}@enderror</span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <label wire:model="sSecondary_FullName"><span class="text-red-600">
                                                        {{ $sSecondary_FirstName }} {{ $sSecondary_MiddleName }}
                                                        {{ $sSecondary_LastName }} </span></label>
                                                ...
                                                <span class="text-danger"> @error('sSecondary_FullName')
                                                        {{ $message }}@enderror</span>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input wire:model="sEmailID1" type="email" class="form-control"
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            {{-- <div class="col-md-3">
                                                                <label for="">Date of Booking </label>
                                                                <input wire:model="dtDOBK" type="date" class="form-control"
                                                                    placeholder="Date of Booking">
                                                                <span class="text-danger"> @error('dtDOBK') {{ $message }}@enderror</span>
                                                            </div> --}}
                                                                ...
                                                                {{-- <div class="col " >
                                                                    ...
                                                                    <select wire:model="iPurchased_unitID_FK" class="form-control" aria-readonly="true">
                                                                    ...
                                                                    <span class="text-danger"> @error('iPurchased_unitID_FK')
                                                                            {{ $message }}@enderror</span>
                                                                </div> --}}
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <input wire:model="sAadhaarCard" type="text" class="form-control"
                                                                                placeholder="1234-1234-1234-1234" autocomplete="off">
                                                                            <span class="text-danger"> @error('sAadhaarCard')
                                                                                    {{ $message }}@enderror</span>

                                                                                <label for="">Aadhaar Card Photo </label>
                                                                                <input wire:model="sAadhaarCard_Photo_sc" type="file" class="form-control">
                                                                                <span class="text-danger"> @error('sAadhaarCard_Photo_sc')
                                                                                        {{ $message }}@enderror</span>
                                                                                ...
                                                                                <div class="col-md-3 overflow-hidden text-center">
                                                                                    ...
                                                                                    @if ($sAadhaarCard_Photo_sc)
                                                                                        <img src="{{ $sAadhaarCard_Photo_sc->temporaryUrl() }}" class="img-fluid-2">
                                                                                    @endif
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-3  ">
                                                                                    ...
                                                                                    <span class="text-danger"> @error('sPanCard') {{ $message }}@enderror</span>
                                                                                        ...
                                                                                        <input type="file" class="form-control" placeholder="upload photo"
                                                                                            wire:model="sPanCard_Photo_sc">
                                                                                        <span class="text-danger"> @error('sPanCard_Photo_sc')
                                                                                                {{ $message }}@enderror</span>

                                                                                        </div>

                                                                                        <div class="col-md-3  overflow-hidden text-center">
                                                                                            @if ($sPanCard_Photo_sc)
                                                                                                <img src="{{ $sPanCard_Photo_sc->temporaryUrl() }}" class="img-fluid-2">
                                                                                            @endif
                                                                                        </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="row">
                                                                                        <div class="col-md-9">
                                                                                            ...
                                                                                            <input wire:model="sResidentialAddress1" type="text" class="form-control"
                                                                                                placeholder="Residential Address" autocomplete="off">
                                                                                            <span class="text-danger"> @error('sResidentialAddress1')
                                                                                                    {{ $message }}@enderror</span>
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <div class="row">
                                                                                                <div class="col-md-9">
                                                                                                    <label for="">Residential Address </label>
                                                                                                    <input wire:model="sResidentialAddress2" type="text" class="form-control"
                                                                                                        placeholder="Residential Address" autocomplete="off">
                                                                                                    <span class="text-danger"> @error('sResidentialAddress2')
                                                                                                            {{ $message }}@enderror</span>
                                                                                                    </div>
