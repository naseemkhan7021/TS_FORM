<x-guest-layout>
    <x-jet-authentication-card>
        <x-slot name="logo">
            <x-jet-authentication-card-logo defaultCompany='1' />
        </x-slot>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-jet-input id="userid" class="block mt-1 w-full" type="text" name="userid" :value="old('userid')" required autofocus autocomplete="userid" />
            </div>
