<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <!-- Role ID -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="current_role⁯_id" value="{{ __('User Current Role') }}" />
            <x-jet-input id="current_role⁯_id" type="text" class="mt-1 block w-full" wire:model.defer="state.current_role⁯_id" autocomplete="current_role⁯_id" readonly/>
            <x-jet-input-error for="current_role⁯_id" class="mt-2" />
        </div>
